        ...
        <div class="contact-container container-block">
            <ul class="list-unstyled contact-list">
                <li class="email"><i class="fa fa-envelope"></i><a
                            href="mailto: yourname@email.com"><?= $profileData['about']['email'] ?></a></li>
                <li class="phone"><i class="fa fa-phone"></i><a
                            href="tel:<?= $profileData['about']['phone'] ?>"><?= $profileData['about']['phone'] ?></a>
                </li>
                <li class="website"><i class="fa fa-globe"></i><a href="//<?= $profileData['about']['site'] ?>"
                                                                  target="_blank"><?= $profileData['about']['site'] ?></a>
                </li>
            </ul>
                ...
                <div class="item">
                    <div class="meta">
                        <div class="upper-row">
                            ...
                            <div class="time"><?= $experience['yearStart'] ?>
                                - <?= $experience['yearEnd'] ?: 'По настоящее время' ?></div>
                        </div><!--//upper-row-->
